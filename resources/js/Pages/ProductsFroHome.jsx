...
export function generateProductItems(products, search) {
    ...
    if (filteredProducts.length === 0) {
        return <div className="col-12 text-center alert alert-warning" role="alert">Aucun produits existe</div>;
    }
    ...
    return (
        <div>
            <div className="container-fluid pt-5 pb-3">
                <h2 style={{ color: 'rgb(133, 41, 205)' }} className="text-center section-title position-relative text-uppercase mx-xl-5 mb-4">
